...
/**
    ...
    * 'current', 'interim' and 'overall'.
*/
public class JDialogExtractExt extends JDialog implements ActionListener
{
	//protected JTextArea textArea;
	protected JProgressBar pbCurrent, pbInterim, pbTotal;
	...
	*/
	public JDialogExtractExt(JFrameExt owner, String title)
	{
	...
	*/
	public JDialogExtractExt(JFrameExt owner, String title, boolean setVisible)
	{
	...
	*/
	public JDialogExtractExt(JFrameExt owner, String title, boolean setVisible, Dimension size)
	{
		super(owner, title);
	...
	*/
	...
	/**
	* Gets the label that displays info regarding the 'total' progress.
	*
	* @return	the label that displays the 'total' progress.
	*/
	...
	*/
	...
	/**
	* Gets the progressbar that displays info regarding the 'total' progress.
	*
	* @return	the progressbar that displays the 'total' progress.
	*/
	public JProgressBar getPBTotal()
	{
		return this.pbTotal;
	}
